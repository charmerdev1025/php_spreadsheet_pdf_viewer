<?php
  ...
  $subscribers = $conn->query($subscribers_query);
  ...
  <aside
    ...
    <div class="collapse navbar-collapse  w-auto h-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        ?>
        <li class="nav-item">
          <a class="nav-link active" href="subscriber.php">
            <div class="icon icon-shape icon-sm text-center  me-2 d-flex align-items-center justify-content-center">
          ...
          <div class="card">
            ...
            ?>
                <tr>
                  ...
                  <td class="text-sm font-weight-normal"><?= $subscriber["first_name"] ?></td>
                  <td class="text-sm font-weight-normal"><?= $subscriber["last_name"] ?></td>
                  <td class="text-sm font-weight-normal"><?= $subscriber["company_email"] ?></td>
                  <td class="text-sm font-weight-normal"><?= $subscriber["subscription_type"] ?></td>
                  <td class="text-sm font-weight-normal"><?= $subscriber["status"] ?></td>
                  <td class="text-sm font-weight-normal"><?= $subscriber["last_used"] ?></td>
                  <td class="text-sm font-weight-normal"><?= $subscriber["date_joined"] ?></td>
                  <td class="text-sm font-weight-normal"><?= $subscriber["date_of_billing"] ?></td>
                  <td class="text-lg">
                    <a class="mx-3 text-info" href="<?= "subscriber_edit.php?id=".$subscriber["id"];?>">
                      <i class="fa fa-pencil"></i>
                    </a>
                    <a href="javascript:void(0);" class="text-danger btn-subscriber-delete" data-subscriberid="<?= $subscriber["id"];?>">
