<?php
  session_start();
  include 'config.php';
  $role_arr = ['user', 'superuser', 'superadmin'];
          ...
          <div class="card">
            ...
            ?>
                  <tr>
                    ...
                    <td class="text-sm font-weight-normal"><?= $user["first_name"] ?></td>
                    <td class="text-sm font-weight-normal"><?= $user["last_name"] ?></td>
                    <td class="text-sm font-weight-normal"><?= $user["email"] ?></td>
                    <td class="text-sm font-weight-normal"><span
                        class="mt-2 badge badge-sm bg-gradient-info"><?= $role_arr[$user["role"]] ?></span></td>
                    <td class="text-lg">
                      <a href="javascript:;" class="mx-3 text-info">
